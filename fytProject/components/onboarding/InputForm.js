...
import { Animated, Dimensions, StyleSheet, View, Text, Button } from 'react-native';
        ...
        <Card>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Button text="Back"
                    ...
                    onPress={() => {this.propshandleBackClick()}}
                    title="Back"
                    name="Back"/>

            <Text style={styles.textView}> {this.props.formFieldName}</Text>
            ...
            <View>
          <Text style={{ fontSize: 30 }}>Please Input {this.props.formFieldName}</Text>
          ...
          <View style={{ width: '100%',justifyContent: 'center',flexDirection: 'column',alignItems: 'center',  }}>
            <Button text="Skip"
                    ...
                    onPress={() => {this.props.handleSkipClick()}} 
                    title="Skip"
                    name="Skip"/>
          </View>
        </Card>
